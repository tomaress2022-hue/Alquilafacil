...
<div class="d-flex align-items-center mb-4">
    ...
    <h2 class="mb-0"><i class="bi bi-tools text-primary me-2"></i> Editar Equipo</h2>
</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="category_id" class="form-select @error('category_id') is-invalid @enderror" required>
                        @foreach($categories as $cat)
                            <option value="{{ $cat->id }}" {{ old('category_id', $equipment->category_id) == $cat->id ? 'selected' : '' }}>
                                {{ $cat->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" min="0" name="daily_price"
                           ...
                           value="{{ old('daily_price', $equipment->daily_price) }}" required>
                ...
                <div class="col-md-3">
                    ...
                    <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                        ...
                        <option value="rented" {{ old('status', $equipment->status) == 'rented' ? 'selected' : '' }}>En alquiler</option>
                        <option value="maintenance" {{ old('status', $equipment->status) == 'maintenance' ? 'selected' : '' }}>Mantenimiento</option>
                    </select>
